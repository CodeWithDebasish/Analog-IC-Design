...
S {}
E {}
N 10 50 110 50 {lab=vinp}
N 10 90 110 90 {lab=vinn}
...
N 10 -0 10 50 {lab=vinp}
N 0 -0 10 -0 {lab=vinp}
N 10 90 10 140 {lab=vinn}
N 0 140 10 140 {lab=vinn}
N 630 -0 630 50 {lab=vop}
N 630 -0 650 0 {lab=vop}
N 630 90 630 130 {lab=xxx}
N 630 130 650 130 {lab=xxx}
C {vcvs.sym} 150 70 0 0 {name=E1 value=1000}
C {vcvs.sym} 590 70 2 0 {name=E2 value=1000}
C {iopin.sym} 0 140 2 0 {name=p1 lab=vinn}
C {iopin.sym} 0 0 2 0 {name=p2 lab=vinp}
